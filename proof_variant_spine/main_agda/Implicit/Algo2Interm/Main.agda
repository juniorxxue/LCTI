...
sound-s (s-∀l-y-𝕚 jump x upᶜ upᵉ upC upD upj) = s-∀l-peek (sound-s x) case-𝕚 (s-peek0 jump) upC upD (↑tyʲ-𝕚 upj)
sound-s (s-∀l-y-𝕔 jump x upᶜ upᵉ upC upD upj) = s-∀l-peek (sound-s x) case-𝕔 (s-peek0 jump) upC upD (↑tyʲ-𝕔 upj)

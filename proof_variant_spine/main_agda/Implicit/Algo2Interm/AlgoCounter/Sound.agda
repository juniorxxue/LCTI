...
sc-sound (s-∀l-y-𝕚 pk s upᶜ upj upᵉ upC upD) = s-∀l-y (pk'-sound pk) (sc-sound s) upᶜ upᵉ upC upD
sc-sound (s-∀l-n-y-𝕚 ¬pk s upᶜ upj upᵉ upC upD) = s-∀l-n-y ¬pk (sc-sound s) upᶜ upᵉ upC upD
sc-sound (s-∀l-n-n-𝕚 ¬pk s upᶜ upj upᵉ upC upD) = s-∀l-n-n ¬pk (sc-sound s) upᶜ upᵉ upC upD
sc-sound (s-∀l-y-𝕔 pk s upᶜ upj upᵉ upC upD) = s-∀l-y (pk'-sound pk) (sc-sound s) upᶜ upᵉ upC upD
sc-sound (s-∀l-n-y-𝕔 ¬pk s upᶜ upj upᵉ upC upD) = s-∀l-n-y ¬pk (sc-sound s) upᶜ upᵉ upC upD
sc-sound (s-∀l-n-n-𝕔 ¬pk s upᶜ upj upᵉ upC upD) = s-∀l-n-n ¬pk (sc-sound s) upᶜ upᵉ upC upD

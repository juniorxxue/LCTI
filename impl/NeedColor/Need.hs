...
data Cccccter = Z | I Cccccter | C Cccccter | Infinity

instance Show Cccccter where
    show Z = "0"
    show (I n) = "I " ++ show n
    show (C n) = "C " ++ show n
    show Infinity = "∞"

need :: Env -> Trm -> Cccccter
need _ (Lit _) = Z
need _ (Var _) = Z

...
data ReExtV◇◆ (Γ : Env n m) (Δ : Env n m) (k : Fin m) (X : Fin m) : Set where
  justexts : ∀ {Γ' Δ'}
           → (newΓ : Γ ◇ k ⇘ Γ')
           → (newΔ : Δ ◆ k ⇘ Δ')
           → (ext : Γ' ⊆ Δ' w/v X)
...
⊆/x-◇◆ : Γ ⊆ Δ w/v k
        → Γ ∋^ k
        → ReExtV◇◆ Γ Δ k k
⊆/x-◇◆ ext-Z^ Z = justexts ◇Z ◆Z ext-Z∙
⊆/x-◇◆ (ext-S^ ext) (S^ in1) with ⊆/x-◇◆ ext in1
... | justexts newΓ newΔ ext₁ = justexts (◇S^ newΓ) (◆S^ newΔ) (ext-S^ ext₁)
⊆/x-◇◆ (ext-S∙ ext) (S∙ in1) with ⊆/x-◇◆ ext in1
... | justexts newΓ newΔ ext₁ = justexts (◇S∙ newΓ) (◆S∙ newΔ) (ext-S∙ ext₁)
⊆/x-◇◆ (ext-S= ext) (S= in1) with ⊆/x-◇◆ ext in1
... | justexts newΓ newΔ ext₁ = justexts (◇S= newΓ) (◆S= newΔ) (ext-S= ext₁)
⊆/x-◇◆ (ext-S⋈ ext) (S⋈ in1) with ⊆/x-◇◆ ext in1
... | justexts newΓ newΔ ext₁ = justexts (◇S⋈ newΓ) {!!} {!!}
⊆/x-◇◆ (ext-S, ext) in1 = {!!}
...
-- ⊆/x-◆◆ (ext-S⋈ tregΓ cloX) (S⋈ inΓ) = justexts {!!} {!!} {!!}

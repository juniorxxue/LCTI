...
▶⨟,-▶,-r (▶S= new x) (svar ext regA) = ▶S= (▶⨟,-▶,-r new ext) x
▶⨟,-▶,-r (▶S^= new x) (evar-sol ext regA) = ▶S= (▶⨟,-▶,-r new ext) x

▶s⨟,-▶s,-r : Γ ⨟ Δ ▶s k , T ⇘ Γ' ⨟ Δ'
           → Γ ⊆ Δ
           → Δ ▶s k , T ⇘ Δ'
▶s⨟,-▶s,-r (▶sS⋈ x) (mark regΓ) with refl ← ▶⨟,-unique x = ▶sS⋈ (▶⨟,-▶,-l x)
▶s⨟,-▶s,-r (▶sS^ new x) (evar ext) = ▶sS^ (▶s⨟,-▶s,-r new ext) x
▶s⨟,-▶s,-r (▶sS∙ new x) (uvar ext) = ▶sS∙ (▶s⨟,-▶s,-r new ext) x
▶s⨟,-▶s,-r (▶sS= new x) (svar ext regA) = ▶sS= (▶s⨟,-▶s,-r new ext) x
▶s⨟,-▶s,-r (▶sS^= new x) (evar-sol ext regA) = ▶sS= (▶s⨟,-▶s,-r new ext) x
...
ss-weaken, (s-arr ss ss₁) new
  ...
  = s-arr (ss-weaken, ss new2) (ss-weaken, ss₁ new1)
...
s-weaken, (s-term-c cloA ap ⊢e s) (↑tmᶜ-e up-e upΣ) new = s-term-c (⊢c-weaken,s cloA (▶s⨟,-▶s,-r new (s-⊆ s)))
                                                                   (≫-weaken,s ap (▶s⨟,-▶s,-r new (s-⊆ s)))
                                                                   (t-weaken, ⊢e (▶,-▶s,-𝕣 (▶s⨟,-▶s,-r new (s-⊆ s))) ↑tmᶜ-τ up-e)
                                                                   (s-weaken, s upΣ new)
s-weaken, (s-term-o opnA ⊢e ss s) (↑tmᶜ-e up-e upΣ) new
  with ⟨ Ω' , ⟨ new1 , new2 ⟩ ⟩ ← ▶s⨟,-Ω-exist new (s-⊆ s) (ss-⊆ ss)
  = s-term-o (⊢o-weaken,s opnA (▶s⨟,-▶s,-l new2))
             (t-weaken, ⊢e (▶,-▶s,-𝕣 (▶s⨟,-▶s,-l new2)) ↑tmᶜ-□ up-e)
             (ss-weaken, ss new2)
             (s-weaken, s upΣ new1)

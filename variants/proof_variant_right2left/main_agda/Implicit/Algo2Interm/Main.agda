...
sound-ss (s-arr s s₁) = s-arr₁ (sound-ss s) (s-⊆-prv (sound-ss s₁) (ss-⊆ s))
...
sc-~ s'@(s-term-o opnA ⊢e ss s) = ~sI (t-⊆-prv (sound ⊢e) (ss-⊆ ss)) (~s-⊆-prv (sc-~ s) (ss-⊆ ss))
...
sound-s (s-term-o opnA ⊢e ss s) = s-arr₂ (sound-ss ss) (s-⊆-prv (sound-s s) (ss-⊆ ss))

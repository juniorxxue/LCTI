...
ⅆ-⊆/c : Δ ⅆ Δ' ≋ Γ ⅆ Γ'
     ...
     → Γ ⊆ Δ w/t A w/c j
ⅆ-⊆/c dd (⊆Z regΓ cloA)
  with refl ← ⅆ-out-eq dd = ⊆Z (⊆-regular regΓ (ⅆ-l-⊆ dd)) (⊆-⊢c cloA (ⅆ-l-⊆ dd))
ⅆ-⊆/c dd (⊆∞ ext) = ⊆∞ (ⅆ-⊆/ dd ext)
ⅆ-⊆/c dd (⊆I ext ext₁) with ⅆ-total-mid dd (⊆/c-⊆ ext₁) (⊆/-⊆ ext)
... | ⟨ Ω' , ⟨ dd1 , dd2 ⟩ ⟩ = ⊆I (ⅆ-⊆/ dd2 ext) (ⅆ-⊆/c dd1 ext₁)
ⅆ-⊆/c dd (⊆C cloA ext) = ⊆C (⊆-⊢c cloA (ⅆ-l-⊆ dd)) (ⅆ-⊆/c dd ext)
ⅆ-⊆/c dd (⊆∀-I ext upj) with ⊆-sregular' (⊆/c-⊆ ext)
... | reg-S= r regA = ⊆∀-I (ⅆ-⊆/c (ⅆS==2 dd (⊆-⊢r regA (ⅆ-l-⊆ dd))) ext) upj
ⅆ-⊆/c dd (⊆∀-I-no ext upj) = ⊆∀-I-no (ⅆ-⊆/c (ⅆS^ dd) ext) upj
ⅆ-⊆/c dd (⊆∀-C ext upj) with ⊆-sregular' (⊆/c-⊆ ext)
... | reg-S= r regA = ⊆∀-C (ⅆ-⊆/c (ⅆS==2 dd (⊆-⊢r regA (ⅆ-l-⊆ dd))) ext) upj
ⅆ-⊆/c dd (⊆∀-C-no ext upj) = ⊆∀-C-no (ⅆ-⊆/c (ⅆS^ dd) ext) upj
ⅆ-⊆/c dd (⊆∀-T ext upj) with ⊆-sregular' (⊆/c-⊆ ext)
... | reg-S= r regA = ⊆∀-T (ⅆ-⊆/c (ⅆS==1 dd (⊆-⊢r regA (ⅆ-l-⊆ dd))) ext) upj
ⅆ-⊆/c dd (⊆I-X regΓ cloX)
  with refl ← ⅆ-out-eq dd = ⊆I-X (⊆-regular regΓ (ⅆ-l-⊆ dd)) (⊆-⊢c cloX (ⅆ-l-⊆ dd))
ⅆ-⊆/c dd (⊆C-X regΓ cloX)
  with refl ← ⅆ-out-eq dd = ⊆C-X (⊆-regular regΓ (ⅆ-l-⊆ dd)) (⊆-⊢c cloX (ⅆ-l-⊆ dd))
ⅆ-⊆/c dd (⊆T-X regΓ cloX)
  with refl ← ⅆ-out-eq dd = ⊆T-X (⊆-regular regΓ (ⅆ-l-⊆ dd)) (⊆-⊢c cloX (ⅆ-l-⊆ dd))
...
complete-ss+ (s-arr₁ s s₁) (ext-arr ext ext₁)
  ...
  with ih ← complete-ss+ {Γ = Ψ} s₁ (ⅆ-⊆/ diff ext₁) = s-arr (complete-ss- s ext) (s+-subirrev-final ih diff (⊆/-⊢c ext₁))
...
... | inj₁ opnA
  ...
  = s-term-o opnA (t-irrev-⊆ ⊢e (⊆/c-⊆ ext₁)) (complete-ss- s ext) (s-subirrev-final ih diff (⊆/c-⊢c ext₁))
... | inj₂ cloA
  with refl ← ⊆/-⊢c-eq ext cloA
  = s-term-c cloA (s--≫ s) (t-irrev-⊆ (subsumption0 ⊢e) (⊆/c-⊆ ext₁)) (complete-s s₁ ext₁ j~Σ)
complete-s {j = 𝕔 j} (s-arr₃ cloA grd s) (⊆C cloA' ext) (~C ⊢e j~Σ) = s-term-c cloA grd (t-irrev-⊆ ⊢e (⊆/c-⊆ ext)) (complete-s s ext j~Σ)
-- s-term-c cloA' (⊆-⊢c-≫ (⊆/c-⊆ ext) cloA' grd) ⊢e (complete-s s ext j~Σ)

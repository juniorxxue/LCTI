...
sound-s (s-∀l-n-y-𝕚 x upᶜ upj upᵉ upC upD) = s-∀l (sound-s x) case-𝕚 (s-find0 x) upC upD (↑tyʲ-𝕚 upj)
sound-s (s-∀l-n-n-𝕚 x upᶜ upj upᵉ upC upD) = s-∀l-no-appear (sound-s x) case-𝕚 (s-¬ε (sc-sound x) Z Z) upC upD (↑tyʲ-𝕚 upj)
sound-s (s-∀l-n-y-𝕔 x upᶜ upj upᵉ upC upD) = s-∀l (sound-s x) case-𝕔 (s-find0 x) upC upD (↑tyʲ-𝕔 upj)

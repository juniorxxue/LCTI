...
⊢weaken (⊢lam-a-∞ ⊢e) n≤l = ⊢lam-a-∞ (⊢weaken ⊢e (s≤s n≤l))
⊢weaken (⊢lam-a-n ⊢e) n≤l = ⊢lam-a-n (⊢weaken ⊢e (s≤s n≤l))
⊢weaken (⊢lam-a-Z ⊢e) n≤l = ⊢lam-a-Z (⊢weaken ⊢e (s≤s n≤l))
...
⊢strengthen (⊢lam-a-∞ ⊢e) (sd-lam-a sd) n≤l = ⊢lam-a-∞ (⊢strengthen ⊢e sd (s≤s n≤l))
⊢strengthen (⊢lam-a-n ⊢e) (sd-lam-a sd) n≤l = ⊢lam-a-n (⊢strengthen ⊢e sd (s≤s n≤l))
⊢strengthen (⊢lam-a-Z ⊢e) (sd-lam-a sd) n≤l = ⊢lam-a-Z (⊢strengthen ⊢e sd (s≤s n≤l))

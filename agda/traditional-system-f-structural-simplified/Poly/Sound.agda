...
⊢spl-eq ⊢e (have-t st sts spl) = ⊢spl-eq (⊢tapp ⊢e st) spl
...
⊩-elim ⊢e (⊩cons-t ⊢es st1) (have-t st st2 spl) rewrite substs-unique st1 st2 = ⊩-elim (⊢tapp ⊢e st) ⊢es spl
...
sound-≤ (s-∀-t st A≤Σ) (have-t st₁ sts spl) rewrite subst-unique st st₁ = ⊩cons-t (sound-≤ A≤Σ spl) sts

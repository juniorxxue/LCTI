...
s-strengthen, (s-∀l-tail x₁ ic tail upC upD upj) x =  ?
...
s-strengthen= (s-∀l-tail x₁ ic tail upC upD upj) x (↑ty-∀ x₂) (↑ty-arr x₃ x₄) (↑tyʲ-𝕚 x₅) = ?
s-strengthen= (s-∀l-tail x₁ ic tail upC upD upj) x (↑ty-∀ x₂) (↑ty-arr x₃ x₄) (↑tyʲ-𝕔 x₅) = ?

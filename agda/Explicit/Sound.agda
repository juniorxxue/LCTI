module Explicit.Sound where

open import Explicit.Common
open import Explicit.Decl
open import Explicit.Decl.Subst
open import Explicit.Decl.Properties
open import Explicit.Algo
open import Explicit.Algo.Subsumption
...
⊩-elim ⊢e (⊩cons-t ⊢es) (have-t st spl) = ⊩-elim (⊢tapp ⊢e st) ⊢es spl
...
sound-≤ (s-∀-t st A≤Σ) (have-t st' spl) rewrite subst-unique st st' = ⊩cons-t (sound-≤ A≤Σ spl)
...
sound-c {A̅ = A̅} (⊢tapp {A = A} {B} ⊢e st) spl = sound-c ⊢e (have-t st spl)

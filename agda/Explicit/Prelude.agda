...
open import Data.Fin using (Fin; punchIn; punchOut; inject₁; pinch; toℕ) renaming (zero to #0; suc to #S; _+_ to _#+_; pred to #pred; _≤_ to _F≤_) public

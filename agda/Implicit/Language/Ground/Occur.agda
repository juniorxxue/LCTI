...
grd-ε (ε-arr-r ¬inA inA) inΓ (grd-arr apA apA₁) = ε-arr-r {!!} (grd-ε inA inΓ apA₁)
...
grd-ε-rev (ε-arr-r ¬inA inA%) ninΓ inΓ (grd-var= x) = ⊥-elim (εᵍ-:=-false x (ε-arr-r {!!} inA%) ninΓ)
grd-ε-rev (ε-arr-r ¬inA inA%) ninΓ inΓ (grd-arr apA apA₁) = ε-arr-r {!!} (grd-ε-rev inA% ninΓ inΓ apA₁)

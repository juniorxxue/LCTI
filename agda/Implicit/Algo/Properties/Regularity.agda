...
s-env-in (s-term-c nd s cloA ap ⊢e) = s-env-in s
...
s-⊢rᶜ (s-term-c nd s cloA ap ⊢e) = ⊢rᶜ-term (s-⊢rᶜ s)
...
s-⊢r (s-term-c nd s cloA ap ⊢e) = ⊢r-arr (⊆-⊢r' (⊢c-≫-⊢r (s-env-out s) cloA ap) (s-⊆ s)) (s-⊢r s)

...
ss-strengthen^ (s-arr s s₁) newΓ newΔ (↑ty-arr upA upA₁) (↑ty-arr upB upB₁)
  with ⟨ Ω , newΩ ⟩ ← ◀^-⊆-total (ss-⊆ s₁) (ss-⊆ s) newΓ newΔ = s-arr (ss-strengthen^ s newΩ newΔ upB upA) (ss-strengthen^ s₁ newΓ newΩ upA₁ upB₁)
...
s-strengthen^ (s-term-c cloA ap ⊢e s) newΓ newΔ (↑ty-arr upA upA₁) (↑ty-arr upB upB₁) (↑tyᶜ-e up-e upΣ)
  with refl ← ⊢id0 ⊢e
  = s-term-c (⊢c-strengthen^ cloA newΔ upA)
             (≫-strengthen^ ap (s-env-out s) newΔ upA upB)
             (t-strengthen^ ⊢e (◀^-𝕣 newΔ) upB up-e (↑tyᶜ-τ upB))
...
s-strengthen^ (s-term-o opnA ⊢e ss s) newΓ newΔ (↑ty-arr upA upA₁) (↑ty-arr upB upB₁) (↑tyᶜ-e up-e upΣ)
  with ⟨ Ω' , newΩ ⟩ ← ◀^-⊆-total (s-⊆ s) (ss-⊆ ss) newΓ newΔ
  = s-term-o (⊢o-strengthen^ opnA newΩ upA)
             (t-strengthen^ ⊢e (◀^-𝕣 newΩ) upB up-e ↑tyᶜ-□)
             (ss-strengthen^ ss newΩ newΔ upB upA)
             (s-strengthen^ s newΓ newΩ upA₁ upB₁ upΣ)

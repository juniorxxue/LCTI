...
ss-strengthen, (s-arr ss ss₁) newΓ newΔ
  with ◀,-⊆-total (ss-⊆ ss₁) newΓ
... | ⟨ Ω' , newΩ ⟩ = s-arr (ss-strengthen, ss newΩ newΔ) (ss-strengthen, ss₁ newΓ newΩ)
...
s-strengthen, (s-term-c cloA ap ⊢e s) newΓ newΔ (↑tmᶜ-e up-e upΣ) = s-term-c (⊢c-strengthen, cloA newΔ) (≫-strengthen, ap newΔ)
                                                                             (t-strengthen, ⊢e (◀,-𝕣 newΔ) ↑tmᶜ-τ up-e) (s-strengthen, s newΓ newΔ upΣ)
s-strengthen, (s-term-o opnA ⊢e ss s) newΓ newΔ (↑tmᶜ-e up-e upΣ) with ◀,-⊆-total (s-⊆ s) newΓ
... | ⟨ Ω' , newΩ ⟩ = s-term-o (⊢o-strengthen, opnA newΩ) (t-strengthen, ⊢e (◀,-𝕣 newΩ) ↑tmᶜ-□ up-e) (ss-strengthen, ss newΩ newΔ) (s-strengthen, s newΓ newΩ upΣ)

...
ss-strengthen= (s-arr ss ss₁) newΓ newΔ (↑ty-arr upA upA₁) (↑ty-arr upB upB₁)
  with ⟨ Ω , newΩ ⟩ ← ◀=-⊆-total (ss-⊆ ss₁) newΓ = s-arr (ss-strengthen= ss newΩ newΔ upB upA) (ss-strengthen= ss₁ newΓ newΩ upA₁ upB₁)
...
s-strengthen= (s-term-c cloA ap ⊢e s) newΓ newΔ (↑ty-arr upA upA₁) (↑ty-arr upB upB₁) (↑tyᶜ-e up-e upΣ)
  with refl ← ⊢id0 ⊢e = s-term-c (⊢c-strengthen= cloA newΔ upA)

...
⇌s-⊢o-r : Δ ⊢o A
        → Γ & Δ ⇌s Γ' & Δ'
        → Δ' ⊢o A
⇌s-⊢o-r (⊢o-var-^ x) tf = ⊢o-var-^ (⇌s-∋^-r x tf)
⇌s-⊢o-r (⊢o-arr-l opnA) tf = ⊢o-arr-l (⇌s-⊢o-r opnA tf)
⇌s-⊢o-r (⊢o-arr-r opnA) tf = ⊢o-arr-r (⇌s-⊢o-r opnA tf)
⇌s-⊢o-r (⊢o-∀ opnA) tf = ⊢o-∀ (⇌s-⊢o-r opnA (uvar tf))
...
s-irrev (s-term-c cloA ap ⊢e s) tf = s-term-c (⇌s-⊢c-r cloA tf) (⇌s-≫-r ap tf) (t-irrev ⊢e (⇌s-⇌-r tf)) (s-irrev s tf)
s-irrev (s-term-o opnA ⊢e ss s) tf with  ⇌s-Ω (s-⊆ s) tf
... | ⟨ Ω' , tf' ⟩ = s-term-o (⇌s-⊢o-r opnA tf') (t-irrev ⊢e (⇌s-⇌-r tf')) (ss-irrev ss (⇌s-arr tf tf' (ss-⊆ ss))) (s-irrev s tf')

...
s2-sregular (s-bot regΔ regA) = regΔ
...
s2-weaken= (s-bot regΔ regA) new ↑ty-bot upB ↑tyʲ-∞ = s-bot (sregular-weaken= regΔ new) (⊢r-weaken= regA new upB)

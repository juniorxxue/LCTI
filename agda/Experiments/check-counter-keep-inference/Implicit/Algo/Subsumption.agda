...
s-refined s'@(s-term-o ⊢e s s₁) with ≤id0 s
...
subsumption {Σ' = [ e ]↝ Σ'} (⊢lam₂ ⊢e ⊢e₁) (have-e spl) (⊕cons-e ch) (s-term-o ⊢e₂ s s₁) rewrite inf-unique ⊢e (⊢a-m-w' ⊢e₂) =

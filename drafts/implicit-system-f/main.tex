...
\begin{mathpar}
    ...
    {\Gamma \vdash_{S_\tau~n} \forall a. ~A <: [B/\hat{a}]C }    
...
\inferrule*[lab=S-$\forall$-TApp]
{\Psi , \hat{a} = B \vdash A <: \Sigma \dashv \Psi', \hat{a}= B \rightsquigarrow C}
{\Psi \vdash \forall a. A <: \boxed{B} \leadsto \Sigma \dashv \Psi' \rightsquigarrow [B/\hat{a}]C }
\end{mathpar}

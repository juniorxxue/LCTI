...
\begin{mathpar}
    ...
    \inferrule*[lab=TAbs2]
    {\Gamma, a \vdash_\infty e : A}
    {\Gamma \vdash_\infty \Lambda a.~e : \forall a .~ A}
    
    \inferrule*[lab=TAbs3]
    {\Gamma  \vdash_n \Lambda a.~e : \forall a .~ A}
    {\Gamma \vdash_{S_\tau~n}  \Lambda a.~e : \forall a .~ A}
    
    \inferrule*[lab=TApp]
    {\Gamma \vdash_{S_{\tau}~n} e : \forall a. ~B}
...
\begin{mathpar}
    ...
    {\Gamma \vdash_{n} \forall a. ~A }
    {\Gamma \vdash_{S_\tau~n} \forall a. ~A }    
\end{mathpar}
...
{\Gamma, a \vdash B \Rightarrow e \Rightarrow A}
{\Gamma \vdash \forall a.~B \Rightarrow \Lambda a.~e \Rightarrow \forall a.~A}

\inferrule*[lab=T-TAbs3]
{\Gamma \vdash \Sigma \Rightarrow \Lambda a.~e \Rightarrow \forall a.~A}
{\Gamma \vdash \boxed{B} \leadsto \Sigma \Rightarrow \Lambda a.~e \Rightarrow \forall a.~A}

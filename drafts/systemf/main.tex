...
{\Gamma \vdash \square \Rightarrow g \Rightarrow A \\
 \Gamma \vdash A <: \Sigma \dashv \Gamma, \Psi \rightsquigarrow B}
{\Gamma \vdash \Sigma \Rightarrow g \Rightarrow \Psi(B)}
...
{\Psi \vdash \forall A <: \boxed{e} \leadsto \Sigma \dashv \Psi', \hat{o} \rightsquigarrow B}

\inferrule*[lab=S-All-L-Eq]
{\Psi, \hat{o} \vdash A <: \boxed{e} \leadsto \Sigma \dashv \Psi', =A \rightsquigarrow B}
{\Psi \vdash \forall A <: \boxed{e} \leadsto \Sigma \dashv \Psi' , =A \rightsquigarrow B}

\inferrule*[lab=S-$\forall$-t]
{\Psi ,= B \vdash A <: \Sigma \dashv \Psi',= B \rightsquigarrow C}
{\Psi \vdash \forall A <: \boxed{B} \leadsto \Sigma \dashv \Psi' , =B \rightsquigarrow C }
\end{mathpar}

...
polyTypUncurry :: Typ
polyTypUncurry = TUncurry [idTyp] (TProd TInt TBool)
...
--   , Example "A10 (uncurried)" (ETrm polyTypUncurry (ETrm idTyp EEmpty)) (Var 0 `AppUncurry` [Var 1])
--       "poly(id)"
...
--   , Example "A11 (uncurried)" (ETrm polyTypUncurry EEmpty) (Var 0 `AppUncurry` [Abs (Var 0)])
--       "poly(λx. x)"

--   , Example "A11 (Fc translation, uncurried)" (ETrm polyTypUncurry EEmpty) (Var 0 `AppUncurry` [TAbs (Abs (Var 0))])
--       "poly(Λa. λx. x : a → a)"
...
--   , Example "A12 (Fc translation, uncurried)" (ETrm idTypUncurry (ETrm polyTypUncurry EEmpty)) (Var 0 `AppUncurry` [Var 1] `AppUncurry` [TAbs (Abs (Var 0))])
--       "id(poly)(Λa. λx. x : a → a)"
...
--   , Example "B1 (uncurried)" EEmpty (Abs (Pair `App` (Var 0 `AppUncurry` [LitInt 1]) `App` (Var 0 `AppUncurry` [LitBool True])))
--       "λf. (f(1), f(True))"

--   , Example "B1 (Fc translation 1, uncurried)" EEmpty (Abs (Pair `App` (Var 0 `AppUncurry` [LitInt 1]) `App` (Var 0 `AppUncurry` [LitBool True])) `Ann` (idTypUncurry `TArr` TProd TInt TBool))
--       "(λf. (f(1), f(True))) : (∀a. (a) → a) → Int × Bool"

--   , Example "B1 (Fc translation 2, uncurried)" EEmpty (AbsAnn idTypUncurry (Pair `App` (Var 0 `AppUncurry` [LitInt 1]) `App` (Var 0 `AppUncurry` [LitBool True])))
--       "λf : ∀a. (a) → a. (f(1), f(True))"
...
--   , Example "B2 (uncurried)" (ETrm polyTypUncurry (ETrm headTypUncurry EEmpty)) (Abs (Var 1 `AppUncurry` [Var 2 `AppUncurry` [Var 0]]))
--       "λxs. poly(head(xs))"

--   , Example "B2 (Fc translation 1, uncurried)" (ETrm polyTypUncurry (ETrm headTypUncurry EEmpty)) (Abs (Var 1 `AppUncurry` [Var 2 `AppUncurry` [Var 0]]) `Ann` (TList idTyp `TArr` TProd TInt TBool))
--       "(λxs. poly(head(xs))) : [∀a. a → a] → Int × Bool"
    
--   , Example "B2 (Fc translation 2, uncurried)" (ETrm polyTypUncurry (ETrm headTypUncurry EEmpty)) (AbsAnn (TList idTyp) (Var 1 `AppUncurry` [Var 2 `AppUncurry` [Var 0]]))
--       "λxs : [∀a. a → a]. poly(head(xs))"

--   , Example "C1" (ETrm lengthTyp (ETrm (TList idTyp) EEmpty)) (Var 0 `App` Var 1)
--       "length ids"

--   , Example "C1 (uncurried)" (ETrm lengthTypUncurry (ETrm (TList idTyp) EEmpty)) (Var 0 `AppUncurry` [Var 1])
--       "length(ids)"
    
--   , Example "C2" (ETrm tailTyp (ETrm (TList idTyp) EEmpty)) (Var 0 `App` Var 1)
--       "tail ids"

--   , Example "C2 (uncurried)" (ETrm tailTypUncurry (ETrm (TList idTyp) EEmpty)) (Var 0 `AppUncurry` [Var 1])
--       "tail(ids)"
    
--   , Example "C3" (ETrm headTyp (ETrm (TList idTyp) EEmpty)) (Var 0 `App` Var 1)
--       "head ids"

--   , Example "C3 (uncurried)" (ETrm headTypUncurry (ETrm (TList idTyp) EEmpty)) (Var 0 `AppUncurry` [Var 1])
--       "head(ids)"
...
--     -- TODO
--   , Example "C10 (Fc translation, uncurried)" (ETrm mapTypUncurry (ETrm headTypUncurry (ETrm singleTypUncurry (ETrm (TList idTypUncurry) EEmpty)))) (Var 0 `AppUncurry` [Var 1 `TApp` idTyp, Var 2 `AppUncurry` [Var 3]])
--       "map(head @ (∀a. a → a), single(ids))"
    
--   , Example "D1" (ETrm appTyp (ETrm polyTyp (ETrm idTyp EEmpty))) (Var 0 `App` Var 1 `App` Var 2)
--       "app poly id"

--   , Example "D1" (ETrm appTypUncurry (ETrm polyTypUncurry' (ETrm idTypUncurry EEmpty))) (Var 0 `AppUncurry` [Var 1, Var 2])
--       "app(poly, id)"

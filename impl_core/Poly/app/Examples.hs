...
exampleGroups = Map.fromList
  ...
  , ("A2", ["A2"])
  , ("A3", ["A3", "A3 (Fc translation)"])
  , ("A4", ["A4", "A4 (Fc translation 1)", "A4 (Fc translation 2)"])
  , ("A5", ["A5"])
  , ("A6", ["A6"])
  , ("A7", ["A7", "A7 (Fc translation)"])
  , ("A8", ["A8", "A8 (Fc translation 1)", "A8 (Fc translation 2)", "A8 (Fc translation 3)"])
  , ("A9", ["A9"])
  , ("A10", ["A10"])
  , ("A11", ["A11", "A11 (Fc translation)"])
  , ("A12", ["A12", "A12 (Fc translation)"])
  , ("B1", ["B1", "B1 (Fc translation 1)", "B1 (Fc translation 2)"])
  , ("B2", ["B2", "B2 (Fc translation 1)", "B2 (Fc translation 2)"])
  , ("C1", ["C1"])
  , ("C2", ["C2"])
  , ("C3", ["C3"])
  , ("C4", ["C4"])
  , ("C5", ["C5"])
  , ("C6", ["C6", "C6 (Fc translation 1)", "C6 (Fc translation 2)"])
  , ("C7", ["C7", "C7 (Fc translation)"])
  , ("C8", ["C8"])
  , ("C9", ["C9"])
  , ("C10", ["C10", "C10 (Fc translation)"])
  , ("D1", ["D1"])
  , ("D2", ["D2"])
  , ("D3", ["D3"])
  , ("D4", ["D4", "D4 (Fc translation 1)", "D4 (Fc translation 2)", "D4 (Fc translation 3)"])
  , ("D5", ["D5", "D5 (Fc translation 1)", "D5 (Fc translation 2)"])
  , ("E1", ["E1"])
  , ("E2", ["E2", "E2 (Fc translation 1)", "E2 (Fc translation 2)"])
  , ("E3", ["E3", "E3 (Fc translation 1)", "E3 (Fc translation 2)"])
  , ("F5", ["F5"])
  , ("F6", ["F6"])
  , ("F7", ["F7"])
  , ("F8", ["F8"])
...
examplesList = 
  ...
  , Example "A1 (Fc translation 1)" EEmpty (TAbs $ TAbs $ Ann (Abs (Abs (Var 0))) (TArr (TVar 1) (TArr (TVar 0) (TVar 0))))
      "Λa. Λb. (λx. λy. y) : a → b → b"

  , Example "A1 (Fc translation 1, uncurried)" EEmpty (TAbs $ TAbs $ Ann (AbsUncurry 2 (Var 0)) (TUncurry [TVar 1, TVar 0] (TVar 0)))
      "Λa. Λb. (λ(x, y). y) : (a, b) → b" 
    
  , Example "A1 (Fc translation 2)" EEmpty (TAbs $ TAbs $ AbsAnn (TVar 1) $ AbsAnn (TVar 0) $ Var 0)
      "Λa. Λb. λx : a. λy : b. y"
  ...
  , Example "A3 (uncurried)" (ETrm (TList idTypUncurry) (ETrm chooseTypUncurry EEmpty)) (Var 1 `AppUncurry` [Nil, Var 0])
      "choose(Nil, ids)"

  , Example "A3 (Fc translation, uncurried)" (ETrm (TList idTypUncurry) (ETrm chooseTypUncurry EEmpty)) (Var 1 `AppUncurry` [Nil `Ann` TList idTypUncurry, Var 0])
      "choose(Nil : [∀a. (a) → a], ids)"
    
  , Example "A4" EEmpty (Abs (App (Var 0) (Var 0)))
      "λx. x x"
    
  , Example "A4 (Fc translation 1)" EEmpty (Abs (App (Var 0) (Var 0)) `Ann` autoTyp)
      "(λx. x x) : (∀a. a → a) → (∀a. a → a)"
    
  , Example "A4 (Fc translation 2)" EEmpty (AbsAnn idTyp (App (Var 0) (Var 0)))
      "λx : (∀a. a → a). x x"

  , Example "A4 (uncurried)" EEmpty (AbsUncurry 1 (App (Var 0) (Var 0)))
      "λ(x). x x"

  , Example "A4 (Fc translation, uncurried)" EEmpty (AbsUncurry 1 (AppUncurry (Var 0) [Var 0]) `Ann` autoTypUncurry)
      "(λ(x). x(x)) : (∀a. a → a) → (∀a. a → a)"
    
  , Example "A5" (ETrm idTyp (ETrm autoTyp EEmpty)) (Var 0 `App` Var 1)
      "id auto"

  , Example "A5 (uncurried)" (ETrm idTypUncurry (ETrm autoTypUncurry EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "id(auto)"
    
  , Example "A6" (ETrm idTyp (ETrm auto'Typ EEmpty)) (Var 0 `App` Var 1)
      "id auto'"

  , Example "A6 (uncurried)" (ETrm idTypUncurry (ETrm auto'TypUncurry EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "id(auto')"
  ...
  , Example "A7 (uncurried)" (ETrm chooseTypUncurry (ETrm idTypUncurry (ETrm autoTypUncurry EEmpty))) (Var 0 `AppUncurry` [Var 1, Var 2])
      "choose(id, auto)"
    
  , Example "A7 (Fc translation, uncurried)" (ETrm chooseTypUncurry (ETrm idTypUncurry (ETrm autoTypUncurry EEmpty))) (Var 0 `AppUncurry` [Var 1 `TApp` idTypUncurry, Var 2])
      "choose(id @ (∀a. (a) → a), auto)"
    
  , Example "A8" (ETrm chooseTyp (ETrm idTyp (ETrm auto'Typ EEmpty))) (Var 0 `App` Var 1 `App` Var 2)
      "choose id auto'"
    
  , Example "A8 (Fc translation 1)" (ETrm chooseTyp (ETrm idTyp (ETrm auto'Typ EEmpty))) (Var 0 `App` TAbs (Abs (Var 2 `App` (Var 0 `TApp` TVar 0)) `Ann` TArr idTyp (TArr (TVar 0) (TVar 0))) `App` Var 2)
      "choose (Λa. λf. id f @a : (∀b. b → b) → a → a) auto'"
    
  , Example "A8 (Fc translation 2)" (ETrm chooseTyp (ETrm idTyp (ETrm auto'Typ EEmpty))) (Var 0 `App` TAbs (Abs (Abs (Var 3 `App` Var 1 `App` Var 0)) `Ann` TArr idTyp (TArr (TVar 0) (TVar 0))) `App` Var 2)
  ...
  , Example "A8 (uncurried)" (ETrm chooseTypUncurry (ETrm idTypUncurry (ETrm auto'TypUncurry EEmpty))) (Var 0 `AppUncurry` [Var 1, Var 2])
      "choose(id, auto')"

  , Example "A8 (Fc translation 1, uncurried)" (ETrm chooseTypUncurry (ETrm idTypUncurry (ETrm auto'TypUncurry EEmpty))) (Var 0 `AppUncurry` [TAbs (AbsUncurry 1 (Var 2 `AppUncurry` [Var 0 `TApp` TVar 0]) `Ann` TUncurry [idTypUncurry] (TUncurry [TVar 0] (TVar 0))), Var 2])
      "choose(Λa. λ(f). id(f @a) : (∀b. (b) → b) → (a) → a, auto')"

  , Example "A8 (Fc translation 2, uncurried)" (ETrm chooseTypUncurry (ETrm idTypUncurry (ETrm auto'TypUncurry EEmpty))) (Var 0 `AppUncurry` [TAbs (AbsUncurry 1 (AbsUncurry 1 (Var 3 `AppUncurry` [Var 1 `AppUncurry` [Var 0]])) `Ann` TUncurry [idTypUncurry] (TUncurry [TVar 0] (TVar 0))), Var 2])
  ...
  , Example "A10 (uncurried)" (ETrm polyTypUncurry (ETrm idTypUncurry EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "poly(id)"
    
  , Example "A11" (ETrm polyTyp EEmpty) (Var 0 `App` Abs (Var 0))
      "poly (λx. x)"
    
  , Example "A11 (Fc translation)" (ETrm polyTyp EEmpty) (Var 0 `App` TAbs (Abs (Var 0)))
      "poly (Λa. λx. x)"

  , Example "A11 (uncurried)" (ETrm polyTypUncurry EEmpty) (Var 0 `AppUncurry` [AbsUncurry 1 (Var 0)])
      "poly(λ(x). x)"

  , Example "A11 (Fc translation, uncurried)" (ETrm polyTypUncurry EEmpty) (Var 0 `AppUncurry` [TAbs (AbsUncurry 1 (Var 0))])
      "poly(Λa. λx. x)"
  ...
  , Example "A12 (uncurried)" (ETrm idTypUncurry (ETrm polyTypUncurry EEmpty)) (Var 0 `AppUncurry` [Var 1] `AppUncurry` [Abs (Var 0)])
      "id(poly)(λ(x). x)"

  , Example "A12 (Fc translation, uncurried)" (ETrm idTypUncurry (ETrm polyTypUncurry EEmpty)) (Var 0 `AppUncurry` [Var 1] `AppUncurry` [TAbs (AbsUncurry 1 (Var 0))])
      "id(poly)(Λa. λ(x). x)"

  , Example "B1" EEmpty (Abs (Pair `App` (Var 0 `App` LitInt 1) `App` (Var 0 `App` LitBool True)))
      "λf. (f 1, f True)"
    
  , Example "B1 (Fc translation 1)" EEmpty (Abs (Pair `App` (Var 0 `App` LitInt 1) `App` (Var 0 `App` LitBool True)) `Ann` (idTyp `TArr` TProd TInt TBool))
      "(λf. (f 1, f True)) : (∀a. a → a) → Int × Bool"
    
  , Example "B1 (Fc translation 2)" EEmpty (AbsAnn idTyp (Pair `App` (Var 0 `App` LitInt 1) `App` (Var 0 `App` LitBool True)))
      "λf : ∀a. a → a. (f 1, f True)"

  , Example "B1 (uncurried)" EEmpty (AbsUncurry 1 (PairUncurry `AppUncurry` [Var 0 `AppUncurry` [LitInt 1], Var 0 `AppUncurry` [LitBool True]]))
      "λ(f). (f(1), f(True))"

  , Example "B1 (Fc translation 1, uncurried)" EEmpty (AbsUncurry 1 (PairUncurry `AppUncurry` [Var 0 `AppUncurry` [LitInt 1], Var 0 `AppUncurry` [LitBool True]]) `Ann` (TUncurry [idTypUncurry] (TProd TInt TBool)))
      "(λ(f). (f(1), f(True))) : (∀a. (a) → a) → Int × Bool"

  , Example "B1 (Fc translation 2, uncurried)" EEmpty (AbsAnn idTypUncurry (PairUncurry `AppUncurry` [Var 0 `AppUncurry` [LitInt 1], Var 0 `AppUncurry` [LitBool True]]))
      "λf : ∀a. (a) → a. (f(1), f(True))"

  , Example "B2" (ETrm polyTyp (ETrm headTyp EEmpty)) (Abs (Var 1 `App` (Var 2 `App` Var 0)))
      "λxs. poly (head xs)"
    
  , Example "B2 (Fc translation 1)" (ETrm polyTyp (ETrm headTyp EEmpty)) (Abs (Var 1 `App` (Var 2 `App` Var 0)) `Ann` (TList idTyp `TArr` TProd TInt TBool))
  ...
  , Example "B2 (uncurried)" (ETrm polyTypUncurry (ETrm headTypUncurry EEmpty)) (AbsUncurry 1 (Var 1 `AppUncurry` [Var 2 `AppUncurry` [Var 0]]))
      "λ(xs). poly(head(xs))"

  , Example "B2 (Fc translation 1, uncurried)" (ETrm polyTypUncurry (ETrm headTypUncurry EEmpty)) (AbsUncurry 1 (Var 1 `AppUncurry` [Var 2 `AppUncurry` [Var 0]]) `Ann` ([TList idTypUncurry] `TUncurry` TProd TInt TBool))
      "(λ(xs). poly(head(xs))) : [∀a. (a) → a] → Int × Bool"
    
  , Example "B2 (Fc translation 2, uncurried)" (ETrm polyTypUncurry (ETrm headTypUncurry EEmpty)) (AbsAnn (TList idTypUncurry) (Var 1 `AppUncurry` [Var 2 `AppUncurry` [Var 0]]))
      "λxs : [∀a. (a) → a]. poly(head(xs))"

  , Example "C1" (ETrm lengthTyp (ETrm (TList idTyp) EEmpty)) (Var 0 `App` Var 1)
      "length ids"

  , Example "C1 (uncurried)" (ETrm lengthTypUncurry (ETrm (TList idTypUncurry) EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "length(ids)"
    
  , Example "C2" (ETrm tailTyp (ETrm (TList idTyp) EEmpty)) (Var 0 `App` Var 1)
      "tail ids"

  , Example "C2 (uncurried)" (ETrm tailTypUncurry (ETrm (TList idTypUncurry) EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "tail(ids)"
    
  , Example "C3" (ETrm headTyp (ETrm (TList idTyp) EEmpty)) (Var 0 `App` Var 1)
      "head ids"

  , Example "C3 (uncurried)" (ETrm headTypUncurry (ETrm (TList idTypUncurry) EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "head(ids)"
    
  , Example "C4" (ETrm singleTyp (ETrm idTyp EEmpty)) (Var 0 `App` Var 1)
      "single id"

  , Example "C4 (uncurried)" (ETrm singleTypUncurry (ETrm idTyp EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "single(id)"
    
  , Example "C5" (ETrm idTyp (ETrm (TList idTyp) EEmpty)) (Cons `App` Var 0 `App` Var 1)
      "cons id ids"

  , Example "C5 (uncurried)" (ETrm idTypUncurry (ETrm (TList idTypUncurry) EEmpty)) (ConsUncurry `AppUncurry` [Var 0, Var 1])
      "cons(id, ids)"

  , Example "C6" (ETrm (TList idTyp) EEmpty) (Cons `App` Abs (Var 0) `App` Var 0)
      "cons (λx. x) ids"
    
  , Example "C6 (Fc translation 1)" (ETrm (TList idTyp) EEmpty) (Cons `App` idTrm `App` Var 0)
      "cons (Λa. λx. x : a → a) ids"
    
  , Example "C6 (Fc translation 2)" (ETrm (TList idTyp) EEmpty) (Cons `App` TAbs (AbsAnn (TVar 0) (Var 0)) `App` Var 0)
      "cons (Λa. λx : a. x) ids"

  , Example "C6 (uncurried)" (ETrm (TList idTypUncurry) EEmpty) (ConsUncurry `AppUncurry` [AbsUncurry 1 (Var 0), Var 0])
      "cons(λ(x). x, ids)"
      
  , Example "C6 (Fc translation 1, uncurried)" (ETrm (TList idTypUncurry) EEmpty) (ConsUncurry `AppUncurry` [idTrmUncurry, Var 0])
  ...
  , Example "C7 (Fc translation)" (ETrm appendTyp (ETrm singleTyp (ETrm incTyp (ETrm idTyp EEmpty)))) (Var 0 `App` (Var 1 `App` Var 2) `App` (Var 1 `App` (Var 3 `TApp` TInt)))
      "append (single inc) (single (id @ Int))"

  , Example "C7 (uncurried)" (ETrm appendTypUncurry (ETrm singleTypUncurry (ETrm incTypUncurry (ETrm idTypUncurry EEmpty)))) (Var 0 `AppUncurry` [Var 1 `AppUncurry` [Var 2], Var 1 `AppUncurry` [Var 3]])
      "append(single(inc), single(id))"

  , Example "C7 (Fc translation, uncurried)" (ETrm appendTypUncurry (ETrm singleTypUncurry (ETrm incTypUncurry (ETrm idTypUncurry EEmpty)))) (Var 0 `AppUncurry` [Var 1 `AppUncurry` [Var 2], Var 1 `AppUncurry` [Var 3 `TApp` TInt]])
      "append(single(inc), single(id @ Int))"
  ...
  , Example "C8 (uncurried)" (ETrm appendTypUncurry (ETrm singleTypUncurry (ETrm idTypUncurry (ETrm (TList idTypUncurry) EEmpty)))) (Var 0 `AppUncurry` [Var 1 `AppUncurry` [Var 2], Var 3])
      "append(single(id), ids)"

  , Example "C9" (ETrm mapTyp (ETrm polyTyp (ETrm singleTyp (ETrm idTyp EEmpty)))) (Var 0 `App` Var 1 `App` (Var 2 `App` Var 3))
      "map poly (single id)"

  , Example "C9 (uncurried)" (ETrm mapTypUncurry (ETrm polyTypUncurry (ETrm singleTypUncurry (ETrm idTypUncurry EEmpty)))) (Var 0 `AppUncurry` [Var 1, Var 2 `AppUncurry` [Var 3]])
      "map(poly, single(id))"
  ...
  , Example "C10 (uncurried)" (ETrm mapTypUncurry (ETrm headTypUncurry (ETrm singleTypUncurry (ETrm (TList idTypUncurry) EEmpty)))) (Var 0 `AppUncurry` [Var 1, Var 2 `AppUncurry` [Var 3]])
      "map(head, single(ids))"

  , Example "C10 (Fc translation, uncurried)" (ETrm mapTypUncurry (ETrm headTypUncurry (ETrm singleTypUncurry (ETrm (TList idTypUncurry) EEmpty)))) (Var 0 `AppUncurry` [Var 1 `TApp` idTypUncurry, Var 2 `AppUncurry` [Var 3]])
      "map(head @ (∀a. a → a), single(ids))"
    
  , Example "D1" (ETrm appTyp (ETrm polyTyp (ETrm idTyp EEmpty))) (Var 0 `App` Var 1 `App` Var 2)
      "app poly id"

  , Example "D1 (uncurried)" (ETrm appTypUncurry (ETrm polyTypUncurry (ETrm idTypUncurry EEmpty))) (Var 0 `AppUncurry` [Var 1, Var 2])
      "app(poly, id)"

  , Example "D2" (ETrm revappTyp (ETrm idTyp (ETrm polyTyp EEmpty))) (Var 0 `App` Var 1 `App` Var 2)
      "revapp id poly"

  , Example "D2 (uncurried)" (ETrm revappTypUncurry (ETrm idTypUncurry (ETrm polyTypUncurry EEmpty))) (Var 0 `AppUncurry` [Var 1, Var 2])
      "revapp(id, poly)"
    
  , Example "D3" (ETrm runSTTyp (ETrm argSTTyp EEmpty)) (Var 0 `App` Var 1)
      "runST argST"

  , Example "D3 (uncurried)" (ETrm runSTTypUncurry (ETrm argSTTyp EEmpty)) (Var 0 `AppUncurry` [Var 1])
      "runST(argST)"
    
  , Example "D4" (ETrm appTyp (ETrm runSTTyp (ETrm argSTTyp EEmpty))) (Var 0 `App` Var 1 `App` Var 2)
      "app runST argST"
    
  , Example "D4 (Fc translation 1)" (ETrm appTyp (ETrm runSTTyp (ETrm argSTTyp EEmpty))) (Var 0 `App` (Abs (Var 2 `App` TAbs (Var 0 `TApp` TVar 0)) `Ann` TArr argSTTyp TInt) `App` Var 2)
  ...
  , Example "D4 (Fc translation 1, uncurried)" (ETrm appTypUncurry (ETrm runSTTypUncurry (ETrm argSTTyp EEmpty))) (Var 0 `AppUncurry` [AbsUncurry 1 (Var 2 `AppUncurry` [TAbs (Var 0 `TApp` TVar 0)]) `Ann` TUncurry [argSTTyp] TInt, Var 2])
...
--   -- FreezeML paper additions
  ...
  , Example "Pair (uncurried)" EEmpty ((PairUncurry `AppUncurry` [AbsUncurry 1 (Var 0), LitInt 1]) `Ann` (([TInt] `TUncurry` TInt) `TProd` TInt))
      "(Pair(λ(x). x, 1) : ((Int) → Int) × Int"

  , Example "Pair (Fc translation 1, uncurried)" EEmpty ((PairUncurry `AppUncurry` [AbsUncurry 1 (Var 0) `Ann` TUncurry [TInt] TInt,LitInt 1]) `Ann` (([TInt] `TUncurry` TInt) `TProd` TInt))

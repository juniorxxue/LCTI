...
s-nonempty-case1 (s-∀l-𝕚 s upᶜ upᵉ upC upD) = nz-I
s-nonempty-case1 (s-∀l-𝕔 s upᶜ upᵉ upC upD) = nz-C
s-nonempty-case1 (s-∀l-no-𝕚 s upᶜ upᵉ upC upD) = nz-I
s-nonempty-case1 (s-∀l-no-𝕔 s upᶜ upᵉ upC upD) = nz-C
...
sc-~ (s-∀l-𝕚 s upᶜ upᵉ upC upD) = ~s-strengthen=0 (sc-~ s) (↑ty-arr upC upD) (↑tyᶜ-e upᵉ upᶜ)
sc-~ (s-∀l-𝕔 s upᶜ upᵉ upC upD) = ~s-strengthen=0 (sc-~ s) (↑ty-arr upC upD) (↑tyᶜ-e upᵉ upᶜ)
sc-~ (s-svar-term inΓ s) = sc-~ s
sc-~ (s-∀l-no-𝕚 s upᶜ upᵉ upC upD) = ~s-strengthen^0 (sc-~ s) (↑ty-arr upC upD) (↑tyᶜ-e upᵉ upᶜ)
sc-~ (s-∀l-no-𝕔 s upᶜ upᵉ upC upD) = ~s-strengthen^0 (sc-~ s) (↑ty-arr upC upD) (↑tyᶜ-e upᵉ upᶜ)
...
sound-s (s-∀l-𝕚 s upᶜ upᵉ upC upD) = s-∀l (sound-s s) case-𝕚 (s-find0 s upᵉ upᶜ) upC upD
sound-s (s-∀l-𝕔 s upᶜ upᵉ upC upD) = s-∀l (sound-s s) case-𝕔 (s-find0 s upᵉ upᶜ) upC upD
sound-s (s-svar-term inΓ s) with sc-~ s
... | ~sI ⊢e r = s-svar-𝕚 inΓ (sound-s s)
... | ~sC ⊢e r = s-svar-𝕔 inΓ (sound-s s)
sound-s (s-∀l-no-𝕚 s upᶜ upᵉ upC upD) = s-∀l-no-appear (sound-s s) case-𝕚 (s-¬ε (sc-sound s) Z Z) upC upD
sound-s (s-∀l-no-𝕔 s upᶜ upᵉ upC upD) = s-∀l-no-appear (sound-s s) case-𝕔 (s-¬ε (sc-sound s) Z Z) upC upD

...
↑ty-find (f-arr-𝕚-l x ¬fd) (↑ty-arr upA upA₁) (↑tyʲ-𝕚 upj) lt = f-arr-𝕚-l (↑ty-ε x upA lt) (↑ty-¬ε-prv ¬fd upA₁ lt)
...
↑ty-find' (f-arr-𝕚-l x ¬fd) (↑ty-arr upA upA₁) (↑tyʲ-𝕚 upj) lt = f-arr-𝕚-l (↑ty-ε' x lt upA) (¬ε-↑ty'-inv ¬fd upA₁ lt)
...
find-ε-gen : find A k j
           → k ε A
find-ε-gen (f-∞ x) = x
find-ε-gen (f-arr-𝕚-l x ¬fd) = ε-arr-l ¬fd x

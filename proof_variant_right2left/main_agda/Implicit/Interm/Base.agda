...
_ = ⊢app₁ {A = Int `→ Int} (⊢app₁ {A = Int} (⊢sub (⊢var
                                                    ...
                                                    Z) (s-∀l (s-∀l (s-arr₃ (⊢c-var-= Z) (grd-var= (Z ↑ty-int)) (s-arr₃ (⊢c-var-= (S= Z))
                                                                                                        (grd-var=
                                                                                                         ...
                                                                                                         (s-svar-l
                                                                                                          (reg-S=
                                                                                                           (reg-S=
                                                                                                            ...
                                                                                                            (⊢r-arr ⊢r-int ⊢r-int))
                                                                                                           ⊢r-int)
                                                                                                          (S= (Z (↑ty-arr ↑ty-int ↑ty-int)) (↑ty-arr ↑ty-int ↑ty-int)))))) case-𝕔 (f-arr-𝕔 (f-arr-𝕔 (f-∞ (ε-arr-l (¬ε-var (λ ())) ε-var)))) ↑ty-int (↑ty-arr (↑ty-arr ↑ty-int ↑ty-int)
                                                                                     (↑ty-arr ↑ty-int (↑ty-arr ↑ty-int ↑ty-int))) (↑tyʲ-𝕔 (↑tyʲ-𝕔 ↑tyʲ-∞))) case-𝕔 (f-∀-𝕔 (f-arr-𝕔 (f-arr-𝕔 (f-∞ (ε-arr-r ε-var)))) (↑tyʲ-𝕔 ↑tyʲ-∞)) ↑ty-int (↑ty-arr (↑ty-arr ↑ty-int ↑ty-int)
                                                                               (↑ty-arr ↑ty-int (↑ty-arr ↑ty-int ↑ty-int))) (↑tyʲ-𝕔 (↑tyʲ-𝕔 ↑tyʲ-∞))) gc-var nz-C)
  (⊢sub
                                                  (⊢lit
                                                   (reg-S, reg-Z
                                                    (⊢r-∀

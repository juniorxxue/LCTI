...
ε-≫-∙ (ε-arr-l ¬inA inA) inΓ ninΓ (grd-var= x) = ⊥-elim (εᵍ-:=-false x (ε-arr-l ¬inA inA) ninΓ)
ε-≫-∙ (ε-arr-l ¬inA inA) inΓ ninΓ (grd-arr grd grd₁) = ε-arr-l (¬ε-≫-∙ ¬inA inΓ ninΓ grd₁) (ε-≫-∙ inA inΓ ninΓ grd)
ε-≫-∙ (ε-arr-r inA) inΓ ninΓ (grd-var= x) = ⊥-elim (εᵍ-:=-false x (ε-arr-r inA) ninΓ)
ε-≫-∙ (ε-arr-r inA) inΓ ninΓ (grd-arr grd grd₁) = ε-arr-r (ε-≫-∙ inA inΓ ninΓ grd₁)
...
find-≫-∙ (f-arr-𝕚-l ¬inA x) ninΓ inΓ (grd-var= x₁) = ⊥-elim (εᵍ-:=-false x₁ (ε-arr-l x ¬inA) ninΓ)
find-≫-∙ (f-arr-𝕚-l ¬inA x) ninΓ inΓ (grd-arr grd grd₁) = f-arr-𝕚-l (ε-≫-∙ ¬inA inΓ ninΓ grd) (¬ε-≫-∙ x inΓ ninΓ grd₁)
find-≫-∙ (f-arr-𝕚-r fd) ninΓ inΓ (grd-var= x) = ⊥-elim (εᵍ-:=-false x (ε-arr-r (find-ε-gen fd)) ninΓ)
find-≫-∙ (f-arr-𝕚-r fd) ninΓ inΓ (grd-arr grd grd₁) = f-arr-𝕚-r (find-≫-∙ fd ninΓ inΓ grd₁)
find-≫-∙ (f-arr-𝕔 fd) ninΓ inΓ (grd-var= x) = ⊥-elim (εᵍ-:=-false x (ε-arr-r (find-ε-gen fd)) ninΓ)
find-≫-∙ (f-arr-𝕔 fd) ninΓ inΓ (grd-arr grd grd₁) = f-arr-𝕔 (find-≫-∙ fd ninΓ inΓ grd₁)

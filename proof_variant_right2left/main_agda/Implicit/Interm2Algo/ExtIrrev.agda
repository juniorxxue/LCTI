...
⊆/c-⊢c : Γ ⊆ Δ w/t A w/c j
       → Δ ⊢c A
⊆/c-⊢c (⊆Z cloA regΓ) = regΓ
⊆/c-⊢c (⊆∞ ext) = ⊆/-⊢c ext
⊆/c-⊢c (⊆I ext ext₁) = ⊢c-arr (⊆/-⊢c ext) (⊆-⊢c (⊆/c-⊢c ext₁) (⊆/-⊆ ext))
...
⊆/-irrev-== (ext-arr ext ext₁) newΓ newΔ = let ⟨ Ω' , inst ⟩ = inst-exist' newΓ (⊆/-⊆ ext₁)
                         in ext-arr (⊆/-irrev-== ext inst newΔ) (⊆/-irrev-== ext₁ newΓ inst)
...
⊆/c-irrev-== (⊆I ext ext₁) new1 new2
  with ⟨ Ω , inst ⟩ ← inst-exist' new1 (⊆/c-⊆ ext₁) = ⊆I (⊆/-irrev-== ext inst new2) (⊆/c-irrev-== ext₁ new1 inst)
⊆/c-irrev-== (⊆C x ext) new1 new2 = ⊆C (=⟹-⊢c x new2) (⊆/c-irrev-== ext new1 new2)
...
⊆/-irrev-^= (ext-arr ext ext₁) inΓ newΔ (ε-arr-l ninB inA) = ext-arr (⊆/-irrev-^= ext (⊆/-^in-^out ext₁ ninB inΓ) newΔ inA) ext₁
⊆/-irrev-^= (ext-arr ext ext₁) inΓ newΔ (ε-arr-r inB)
  with ⟨ Ω' , newΩ ⟩ ← inst-exist newΔ (⊆/-⊆ ext) (⊆/-^in-=out ext₁ inB inΓ) = ext-arr (⊆/-irrev-== ext newΩ newΔ) (⊆/-irrev-^= ext₁ inΓ newΩ inB)
...
⊆/c-irrev-^= (⊆I ext ext₁) inΓ newΔ (f-arr-𝕚-l x nfB) = ⊆I (⊆/-irrev-^= ext (⊆/c-^in-^out ext₁ nfB inΓ) newΔ x) ext₁
⊆/c-irrev-^= (⊆I ext ext₁) inΓ newΔ (f-arr-𝕚-r fd)
  with ⟨ Ω' , inst-Ω ⟩ ← inst-exist newΔ (⊆/-⊆ ext) (⊆/c-find-∋= ext₁ inΓ fd) = ⊆I (⊆/-irrev-== ext inst-Ω newΔ) (⊆/c-irrev-^= ext₁ inΓ inst-Ω fd)
⊆/c-irrev-^= (⊆C x ext) inΓ newΔ (f-arr-𝕔 fd) = ⊆C (=⟹-⊢c x newΔ) (⊆/c-irrev-^= ext inΓ newΔ fd)
...
⊆/-irrev-^^ (ext-arr ext ext₁) (¬ε-arr ninA ninA₁) newΓ newΔ
  ...
  = ext-arr (⊆/-irrev-^^ ext ninA ◎Ω newΔ) (⊆/-irrev-^^ ext₁ ninA₁ newΓ ◎Ω)
...
⊆/c-irrev-^^ : Γ ⊆ Δ w/t A w/c j
            ...
            → Δ ◎ k ⇘ Δ'
            → Γ' ⊆ Δ' w/t A w/c j
⊆/c-irrev-^^ (⊆Z regΓ cloA) ninA newΓ newΔ with refl ← ◎-unique newΓ newΔ = ⊆Z (◎-sregular regΓ newΓ) (◎-⊢c cloA newΓ ninA)
⊆/c-irrev-^^ (⊆∞ ext) ninA newΓ newΔ = ⊆∞ (⊆/-irrev-^^ ext ninA newΓ newΔ)
⊆/c-irrev-^^ (⊆I ext ext₁) (¬ε-arr ninA ninA₁) newΓ newΔ
  with ⟨ Ω' , ◎Ω ⟩ ← ◎-total (⊆-∋= (◎-∋= newΓ) (⊆/c-⊆ ext₁)) = ⊆I (⊆/-irrev-^^ ext ninA ◎Ω newΔ) (⊆/c-irrev-^^ ext₁ ninA₁ newΓ ◎Ω)
⊆/c-irrev-^^ (⊆C cloA ext) (¬ε-arr ninA ninA₁) newΓ newΔ = ⊆C (◎-⊢c cloA newΔ ninA) (⊆/c-irrev-^^ ext ninA₁ newΓ newΔ)
⊆/c-irrev-^^ (⊆∀-I ext upj) (¬ε-∀ ninA) newΓ newΔ with ⊆/c-irrev-^^ ext ninA (◎S^ newΓ) (◎S= newΔ)
... | r = ⊆∀-I r upj
⊆/c-irrev-^^ (⊆∀-I-no ext upj) (¬ε-∀ ninA) newΓ newΔ with ⊆/c-irrev-^^ ext ninA (◎S^ newΓ) (◎S^ newΔ)
... | r = ⊆∀-I-no r upj
⊆/c-irrev-^^ (⊆∀-C ext upj) (¬ε-∀ ninA) newΓ newΔ with ⊆/c-irrev-^^ ext ninA (◎S^ newΓ) (◎S= newΔ)
... | r = ⊆∀-C r upj
⊆/c-irrev-^^ (⊆∀-C-no ext upj) (¬ε-∀ ninA) newΓ newΔ with ⊆/c-irrev-^^ ext ninA (◎S^ newΓ) (◎S^ newΔ)
... | r = ⊆∀-C-no r upj
⊆/c-irrev-^^ (⊆∀-T ext upj) (¬ε-∀ ninA) newΓ newΔ with ⊆/c-irrev-^^ ext ninA (◎S= newΓ) (◎S= newΔ)
... | r = ⊆∀-T r upj
⊆/c-irrev-^^ (⊆I-X regΓ cloX) (¬ε-var x) newΓ newΔ with refl ← ◎-unique newΓ newΔ = ⊆I-X (◎-sregular regΓ newΓ) (◎-⊢c cloX newΓ (¬ε-var x))
⊆/c-irrev-^^ (⊆C-X regΓ cloX) ninA newΓ newΔ with refl ← ◎-unique newΓ newΔ = ⊆C-X (◎-sregular regΓ newΓ) (◎-⊢c cloX newΓ ninA)
⊆/c-irrev-^^ (⊆T-X regΓ cloX) ninA newΓ newΔ with refl ← ◎-unique newΓ newΔ = ⊆T-X (◎-sregular regΓ newΓ) (◎-⊢c cloX newΓ ninA)
...
⊆/-irrev-^ (ext-arr ext ext₁) (ε-arr-l ¬inB inA) newΓ
  with ⟨ Ω' , ◎Ω ⟩ ← ◎-total (⊆/-=in-=out ext₁ (◎-∋= newΓ)) = ext-arr (⊆/-irrev-^ ext inA ◎Ω) (⊆/-irrev-^^ ext₁ ¬inB newΓ ◎Ω)
⊆/-irrev-^ (ext-arr ext ext₁) (ε-arr-r inA) newΓ = ext-arr ext (⊆/-irrev-^ ext₁ inA newΓ)
...
⊆/c-irrev-^ (⊆I ext ext₁) (f-arr-𝕚-l x ¬fd) newΓ
  with ⟨ Ω' , ◎Ω ⟩ ← ◎-total (⊆-∋= (◎-∋= newΓ) (⊆/c-⊆ ext₁))
  = ⊆I (⊆/-irrev-^ ext x ◎Ω) (⊆/c-irrev-^^ ext₁ ¬fd newΓ ◎Ω)
⊆/c-irrev-^ (⊆I ext ext₁) (f-arr-𝕚-r fd) newΓ = ⊆I ext (⊆/c-irrev-^ ext₁ fd newΓ)
